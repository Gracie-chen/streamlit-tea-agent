...
SEED_CASES = [
  {
    ...
    "scores": {
      "优雅性": {
        "score": 7,
        "comment": "香气清雅干净，闻着舒服。",
        "suggestion": "保持香气洁净度，避免闷味。"
      },
      "辨识度": {
        "score": 5,
        "comment": "花香存在但不算鲜明。",
        "suggestion": "突出一个明确主香型。"
      },
      "协调性": {
        "score": 7,
        "comment": "入口顺滑，整体融合度较好。",
        "suggestion": "维持平衡，避免甜感单独跳出。"
      },
      "饱和度": {
        "score": 4,
        "comment": "茶汤偏淡，厚度一般。",
